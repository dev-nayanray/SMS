            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li class="active"><a href="bloodcollection.php">Blood Collection</a>
                        </li>
                     ...
                     <div id="add" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Add Collection</h3>
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Donor</label>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Hospital</label>
                                                                                        <input type="text" class="form-control" placeholder="Enter Hospital" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-5">
                                                                                        <label class="login2">Date Collection</label>
                                                                                        <input type="date" class="form-control" placeholder="Enter" />
                                                                                    </div>
                                                                                      <div class="col-lg-4">
                                                                                        <label class="login2">Encharge</label>
                                                                                    <input type="text" class="form-control" placeholder="Nurse/Doctor" />
                                                                                </div>
                                                                                </div>
                                                                            </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true">
                                    <thead>
                                        <tr>
                                            <th data-field="id">Donor Name</th>
                                            <th data-field="name" data-editable="false">Hospital</th>
                                            <th data-field="email" data-editable="false">Blood Type</th>
                                            <th data-field="phone" data-editable="false">No. Of Bags</th>
                                            <th data-field="company" data-editable="false">Date Collection</th>
                                            <th data-field="complete" data-editable="false">Nurse/Doctor Incharge</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Riverside Hospital</td>
                                            <td>Type O</td>
                                            <td >3 Bags</td>
                                            <td>September 18, 2020</td>
                                            <td>Doctor Kett Saten</td>
