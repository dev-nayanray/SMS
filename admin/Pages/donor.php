                     ...
                     <div id="add" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Donor Fullname" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Address</label>
                                                                                        <input type="text" class="form-control" placeholder="Enter Donor Address" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Donor Contact" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Email Address</label>
                                                                                        <input type="email" class="form-control" placeholder="Enter Donor Email Address" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Edwards Steven</td>
                                            <td>California Usa</td>
                                            <td>123-123-1233</td>
                                            <td ><a href="#" style="color: blue"><u><i>Edwardstev@jsail.com</i></u></a></td>
                                            <td>32</td>
                                            <td>Male</td>
                                            <td>Type A,B</td>
                                            <td>Fine</td>
