            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="admin-logo">
                        <a href="../../"><h1 style="margin-left: -23%; color: white">BBMS</h3>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li ><a href="recipient.php">Recipient</a>
                        </li>
                        ...
                        <li class="active"><a href="userlog.php">Use Log</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <button class="btn btn-danger btn-sm " style="margin-right: 96%; margin-bottom: -5%"><i class="fa fa-trash"> Clear Data</i> </button>
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true">
                                    <thead>
                                        <tr>
                                            <th data-field="id">Account Name</th>
                                            <th>Date</th>
                                            <th data-field="name" data-editable="false">Login Time</th>
                                            <th data-field="email" data-editable="false">Logout Time</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                     ...
                     <div id="edit" class="modal modal-adminpro-general Customwidth-popup-WarningModal   modal-zoomInDown fade" role="dialog">
                                                                    ...
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        ...
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <label class="login2">Account Name</label>
                                                                            ...
                                                                            </br><h5 style="margin-left:3%; color: blue"><i><strong><u>User Can</u></strong></i></h5>
                                                                                    <div class="col-lg-12">
                                                                        <div class="i-checks">
                                                                            <label class="">
                                                                                <div class="icheckbox_square-green" style="position: relative;"><input type="checkbox" value="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> <i></i> Add </label>
                                                                                <label class="">
                                                                                <div class="icheckbox_square-green" style="position: relative;"><input type="checkbox" value="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> <i></i> Edit </label>
                                                                                <label class="">
                                                                                <div class="icheckbox_square-green" style="position: relative;"><input type="checkbox" value="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> <i></i> Delete </label>
                                                                                <label class="">
                                                                                <div class="icheckbox_square-green" style="position: relative;"><input type="checkbox" value="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div> <i></i> Print </label>
                                                                        </div>
                                                                    </div>
                                                                                </div>
                                                                            </div>
