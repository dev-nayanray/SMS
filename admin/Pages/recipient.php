            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li class="active"><a href="recipient.php">Recipient</a>
                        </li>
                                                                    ...
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        ...
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Recipient Fullname" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <label class="login2">Address</label>
                                                                                        <input type="text" class="form-control" placeholder="Enter Recipient Address" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <input type="text" class="form-control" placeholder="Enter Recipient Contact" />
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                ...
                                                                                <div class="col-lg-3">
                                                                                        <label class="login2">Blood Type</label>
                                                                                    <select class="form-control custom-select-value" name="account">
                                                                                        <option>O</option>
                                                                                        <option>A,B</option>
                                                                                    </select>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>888-888-8888</td>
                                            <td ><a href="#" style="color: blue"><u><i>CIC@zmail.com</i></u></a></td>
                                            <td>22</td>
                                            <td>Female</td>
                                            <td>Type B</td>
                                            <td>Fine</td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-login-form-inner">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        <h3 align="center">Edit Recipient</h3>
                                                                        <form action="">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
