                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            <li class="nav-item">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                    ...
                                    <span class="admin-name">Sample User</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li><a href="userlog.php">Use Log</a>
                        </li>
                    </ul>
                </div>
            </div>
                                                                    ...
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        ...
                                                                        <form action="#">
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-3">
                                                                                        <label class="login2">Control No.</label>
                                                                                    <input type="text" class="form-control" placeholder="-    -    -    -" />
                                                                                </div>
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">Requested By</label>
                                                                                        <input type="text" class="form-control" placeholder="Name Here!" />
                                                                                    </div>
                                                                                    <div class="col-lg-5">
                                                                                        <label class="login2">Date Request</label>
                                                                                        <input type="date" class="form-control" placeholder="Requested" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-8">
                                                                                        <label class="login2">Recipient</label>
                                                                                    ...
                                                                                    <div class="col-lg-4">
                                                                                        <label class="login2">No. of Bags</label>
                                                                            ...
                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-5">
                                                                                        <label class="login2">Purpose</label>
                                                                                        <input type="text" class="form-control" placeholder="Purpose of Requesting Here!.." />
                                                                                    </div>
                                                                                      <div class="col-lg-4">
                                                                                        <label class="login2">Remarks</label>
                                                                                    <input type="text" class="form-control" placeholder="Remarks Here!.." />
                                                                                </div>
                                                                                </div>
                                                                            </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true">
                                    <thead>
                                        <tr>
                                            <th>Control No.</th>
                                            <th>Requested By</th>
                                            <th data-field="id">Recipient Name</th>
                                            <th data-field="name" data-editable="false">Date Request</th>
                                            <th data-field="email" data-editable="false">Blood Type</th>
                                            <th data-field="phone" data-editable="false">No. Of Bags</th>
                                            <th data-field="company" data-editable="false">Amount</th>
                                            <th data-field="complete" data-editable="false">Purpose</th>
                                            <th>Remarks</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1111112</td>
                                            <td>Alfred Baltasar</td>
                                            <td>Sponge Bob Squarepants</td>
                                            <td>June 03, 2020</td>
                                            <td>Type O</td>
                                            <td >3 Bags</td>
                                            <td><i style="color: blue">$10,200</i></td>
                                            <td>Heart Transfer Operation</td>
                                            <td>ASAP</td>
                                            <td class="datatable-ct"><button class="btn btn-info btn-xs btn-custon-rounded-three" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-xs btn-custon-rounded-three"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>8888888</td>
